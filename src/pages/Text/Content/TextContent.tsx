...
const overview = ContentNode.fromPath('Overview', ContentType.Node, 'Overview', TextPaths.Overview, <TextViewer md={Overview} assets={assets} />);
const deployment = ContentNode.fromPath('Deployment', ContentType.Node, 'Deployment', TextPaths.Deployment, <TextViewer md={Deployment} assets={assets} />);
deployment.contents = [ContentNode.fromPath('Amplify', ContentType.Text, 'Amplify', TextPaths.DeploymentAmplify, <TextViewer md={DeploymentAmplify} assets={assets} />)];
